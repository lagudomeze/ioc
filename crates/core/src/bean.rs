...
use crate::{InitContext, IocError};
...
pub trait BeanSpec {
    ...
    fn try_get<'a>() -> crate::Result<&'a Self::Bean> {
        Self::holder().get().ok_or(IocError::DependNotReady {
...
mod tests {
    ...
    mod dep {
        ...
        use crate::{bean::BeanSpec, init::InitContext, IocError};
