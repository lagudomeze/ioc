...
//! use ioc::run;
//!
//! // this is generated by the ioc_macro `export` from `ioc_macro` module
...
//! ```
//!
//! ## The [`Bean`](ioc_derive::Bean) mvc_macro mvc_macro
//!
...
pub use ioc_core::{
    AppConfigLoader, BeanFamily, BeanSpec, Config, Init, InitContext, InitCtx, IocError, Method,
    Result, Wrapper,
};
pub use ioc_core_macro::{bean, Bean};
pub use ioc_macro::{export, import};
#[cfg(feature = "mvc")]
pub use ioc_mvc::{mvc, run_mvc, OpenApi, OpenApiExt, WebConfig};
...
#[doc(hidden)]
pub mod __private {
    pub use ioc_core::{AppConfigLoader, InitCtx, Result};
